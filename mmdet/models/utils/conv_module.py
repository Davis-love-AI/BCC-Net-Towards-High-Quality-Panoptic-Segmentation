...
class ConvModule(nn.Module):
    ...
    def __init__(self,
        ...
        if self.conv_cfg is None or self.conv_cfg.get('type') != 'DeformConvPack':
    ...
    def init_weights(self):
        ...
        if self.conv_cfg is None or self.conv_cfg.get('type') != 'DeformConvPack':  # DeformConvPack will init itself
