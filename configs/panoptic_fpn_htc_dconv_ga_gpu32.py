...
train_cfg = dict(
    ...
    rcnn=[
        dict(
            assigner=dict(
                type='MaxIoUAssigner',
                pos_iou_thr=0.6,  # TODO try higher iou for positive proposal
                neg_iou_thr=0.6,
                min_pos_iou=0.6,
                ignore_iof_thr=-1),
            sampler=dict(
        ...
        dict(
            assigner=dict(
                type='MaxIoUAssigner',
                pos_iou_thr=0.65,  # TODO try higher iou for positive proposal
                neg_iou_thr=0.65,
                min_pos_iou=0.65,
                ignore_iof_thr=-1),
            sampler=dict(
        ...
        dict(
            assigner=dict(
                type='MaxIoUAssigner',
                pos_iou_thr=0.7,  # TODO try higher iou for positive proposal
                neg_iou_thr=0.7,
                min_pos_iou=0.7,
                ignore_iof_thr=-1),
            sampler=dict(
