...
data = dict(
    ...
    train=dict(
        ...
        size_divisor=64,
        flip_ratio=0.5,
        seg_prefix=data_root + 'annotations/semantic54/semantic54_train2017',
        num_semantic=54,
        with_mask=True,
        with_crowd=True,
        with_label=True,
    ...
    val=dict(
        ...
        size_divisor=64,
        flip_ratio=0,
        seg_prefix=data_root + 'annotations/semantic54/semantic54_val2017',
        num_semantic=54,
        with_mask=True,
        with_crowd=True,
        with_label=True,
...
log_level = 'INFO'
work_dir = './work_dirs/panoptic_fpn'
load_from = None
resume_from = None
workflow = [('train', 1)]
